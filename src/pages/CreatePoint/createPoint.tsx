...
const CreatePoint = () => {
  ...
  const [selectedItems, setSelectItens] = useState<number[]>([]);
  ...
  function handleSelectItem (id: number) {
    ...
    if (alreadySelected >= 0){
      ...
      setSelectItens(filteredItems)

    } else {
      setSelectItens([ ...selectedItems, id ]);
    }
      ...
      <form onSubmit={handleSubmite}>
        ...
        <fieldset>
          ...
          <Map center={initialPosition} zoom={15} onClick={handleMapClick}>
            <TileLayer
              attribution='&am;copy <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'
